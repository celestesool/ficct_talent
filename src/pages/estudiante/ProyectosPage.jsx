  ...
  useEffect(() => {
    const fetchProjects = async () => {
      try {
        ...
        const response = await api.get(`/projects/student/${user.id}`);
  ...
  return (
    <div className={`min-h-screen transition-colors duration-200 ${isDark ? "bg-slate-900" : "bg-gray-50"}`}>
      <div className="container mx-auto px-4 py-8">
        ...
        {/* ERROR */}
        {error && (
          <div className={`mb-6 p-4 rounded-lg border ${isDark ? "bg-red-900/20 border-red-500/50" : "bg-red-50 border-red-200"}`}>
          ...
          <Card className="w-full max-w-2xl max-h-[90vh] overflow-y-auto">
            ...
            <div className="space-y-4">
              ...
              <div className="flex gap-4 mt-6">
                <Button variant="primary" fullWidth onClick={handleSaveProject}>
